...
function Analitik({ hastalar, tedaviler, hatirlaticilar, tamamlananHat, toplamGelir, aylikGelir, islemListesi, personelListesi, iletisimLog, kullanici }) {
  ...
  const benimSatis = benimTedaviler.reduce((s, t) => s + (t.fiyat || 0), 0);
